...
- [ ] **FMP plan tier**: forex, batch quotes, constituents, screener, economic
  calendar, and ETF holdings are all gated on the current tier, and single
  quotes intermittently rate-limit under parallel bursts. Everything is
  substituted (see CLAUDE.md §14) — but if any substitute source breaks, the
  clean fix is the FMP Starter/Premium tier.
